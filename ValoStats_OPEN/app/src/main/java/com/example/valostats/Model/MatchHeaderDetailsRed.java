...
public class MatchHeaderDetailsRed implements Serializable {
    ...
    public MatchHeaderDetailsRed(){

    }

    public MatchHeaderDetailsRed(int adr) {
        this.adr = adr;
    }
