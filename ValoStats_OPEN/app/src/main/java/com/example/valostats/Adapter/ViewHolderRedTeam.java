...
public class ViewHolderRedTeam extends RecyclerView.ViewHolder {
    public ImageView imgMatchRank, imgMatchAgent;

    public TextView tvMatchIGNName,tvMatchIGNTag,tvMatchADR, tvMatchKDRatio, tvMatchKDA, tvMatchHSRatio, tvMatchACS;
    public LinearLayoutCompat layoutCompat;
    public LinearLayout view;

    public ViewHolderRedTeam(@NonNull View itemView) {
        super(itemView);
        ...
        tvMatchHSRatio = itemView.findViewById(R.id.matchHsRatio);
