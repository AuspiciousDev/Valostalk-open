...
import com.example.valostats.LoginActivity;
import com.example.valostats.MainActivity;
import com.example.valostats.MatchDetailsActivity;
import com.example.valostats.Model.MatchHeaderDetails;
import com.example.valostats.Profile;
...
public class adapterRedTeam extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public adapterRedTeam(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_red_team_list, parent, false);
        return new ViewHolderRedTeam(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ViewHolderRedTeam viewh = (ViewHolderRedTeam) holder;
        ...
        viewh.tvMatchHSRatio.setText(String.valueOf(details.getHeadshotratio()).replace(".0", "") + " HS%");
